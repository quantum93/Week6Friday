class DoctorLookup{
  DoctorList(inputQuery) {
    return new Promise(function (resolve, reject) {
      ...
      const url = `https://api.betterdoctor.com/2016-03-01/doctors?location=45.523064%2C%20-122.676483%2C100&user_location=portland&skip=0&limit=10&user_key=ffe395fbf97c561b518013a794f3aba9=${process.env.apiKey}`; // <----- use `` rather than '' to enclose https information
